...
echo '<pre>';
print_r([
    '3,0,1,8,7,2,5,4,9,6'    => minimumSwaps([3,0,1,8,7,2,5,4,9,6]),
    '3,0,1,8,7,2,5,4,9,6,10'    => minimumSwaps([3,0,1,8,7,2,5,4,9,6,10]),
    '3,0,1,8,10,7,11,2,5,4,9,6'    => minimumSwaps([3,0,1,8,10,7,11,2,5,4,9,6]),
    '12,3,13,0,1,8,10,7,11,2,5,4,9,6'    => minimumSwaps([12,3,13,0,1,8,10,7,11,2,5,4,9,6]),
    '1,3,5,2,4,6,8'          => minimumSwaps([1,3,5,2,4,6,8]),
    '4,3,1,2'                => minimumSwaps([4,3,1,2]),
    '2,3,4,1,5'                => minimumSwaps([2,3,4,1,5]),
    ]);
echo '</pre>';
